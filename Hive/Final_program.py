...
#Temperature sensor specific imports
...
#create temperature sensor variable
...
def connected(client):
    ...
    for feed_id in ['poidruche' , 'gx' , 'gy' , 'position','temperature']:
...
def flushData(client,temperatureSensor):
    poidRuche=table[0]
    for i in range(1,4):
        poidRuche+= table[i]
...
while True:
    flushData(client,temperatureSensor)
    sleep(60)
